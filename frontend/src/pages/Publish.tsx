...
export const Publish = () => {
    ...
    return <div>
        <Appbar />
        {localStorage.getItem("token") === null ? <NotSignedIn /> : 
            ...
            <div className="max-w-screen-lg w-full">
                ...
                <button onClick={async () => {
                    ...
                    if (response.data.id) {
                        ...
                        // Handle the case where blogId is undefined
                        console.error('Blog ID is missing in the response');
                        alert('An error occurred: Blog ID is missing in the response');
                    }
